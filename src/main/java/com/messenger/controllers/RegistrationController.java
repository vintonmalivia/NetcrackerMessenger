...
public class RegistrationController {
    ...
    public String addUser(@ModelAttribute(ModelAttributes.USER_FORM) User userForm, BindingResult bindingResult, Model model) {
        ...
        if (!userForm.getPassword().equals(userForm.getPasswordConfirm())){
            ...
            logger.error("The password of the person trying to register with username = {} does not match.",
        ...
        if (!userService.saveUser(userForm)){
            ...
            logger.error("Account with username = {} already exists.", userForm.getUsername());
            return Views.REGISTRATION_HTML;
        }
